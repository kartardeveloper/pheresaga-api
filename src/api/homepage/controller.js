...
module.exports = {
    ...
    createHomepageSection1: async (req, res) => {
        try {
            ...
            res.status(201).json({ message: `${section} section updated successfully`, data: homepages });
        } catch (error) {
    ...
    updateHomepageHeroSection: async (req, res) => {
        try {
            ...
            res.status(200).json({ message: `${section} section updated successfully`, data: homepage });
        } catch (error) {
            res.status(500).json({ message: 'Error updating homepage section', error: error.message });
        }
    },
    ...
    deleteHomepageGallerySection: async (req, res) => {
        try {
            ...
            homepage.gallerySection.forEach(section => {
            ...
            await homepageSections.updateOne({}, { $set: { gallerySection: homepage.gallerySection } });
    
            res.status(200).json({ message: 'Gallery section item deleted successfully' });
        } catch (error) {
            res.status(500).json({ message: 'Error deleting gallery section item', error: error.message });
        }
    },
